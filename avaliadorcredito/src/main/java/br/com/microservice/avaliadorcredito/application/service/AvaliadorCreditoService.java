package br.com.microservice.avaliadorcredito.application.service;
...
import br.com.microservice.avaliadorcredito.infra.clients.CartaoResourceClient;
import br.com.microservice.avaliadorcredito.infra.clients.ClienteResourceClient;
import br.com.microservice.avaliadorcredito.infra.mqueue.SolicitacaoEmissaoCartaoPublisher;
...
public class AvaliadorCreditoService {
    ...
    public SituacaoCliente obeterSituacaoCliente(String cpf) throws DadosClienteNotFoundException, ErroComunicacaoMicroservicesException {
        try {
            ...
            return SituacaoCliente.builder().cliente(clienteResponse.getBody())
    ...
    public RetornoAvaliacaoCliente realizarAvaliacao(String cpf, Long renda) throws DadosClienteNotFoundException, ErroComunicacaoMicroservicesException{
        try {
            ...
            ResponseEntity<List<Cartao>> cartoesResponseRenda = cartoesClient.getCartoesRendaAteh(renda);

            List<Cartao> cartoes = cartoesResponseRenda.getBody();
